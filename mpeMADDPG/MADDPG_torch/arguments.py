...
def parse_args():
    ...
    # environment
    # parser.add_argument("--scenario_name", type=str, default="simple_adversary",
    ...
    parser.add_argument("--old_model_name", type=str, default="models/simple_spread_2104_021513_970000/", \
    ...
    parser.add_argument("--restore_idxs", default=3, type=int, help="")
